describe("the ufo sightings service", function(){
    ...
    beforeEach(inject(function($injector) {
        ...
        $httpBackend.whenGET('http://localhost:3000/uforeports.sqlite/uforeports/' + someSightings[0].id)
        .respond(someSightings[0]);
        
        //prevent uiRouter from giving us false failures. 
        $httpBackend.whenGET('home-view.html').respond("");
